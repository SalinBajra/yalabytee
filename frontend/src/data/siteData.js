export const services = [
  ...
  },
  {
    ...
    text: 'Search-friendly page structure, metadata, performance basics, and content foundations for long-term visibility.',
    outcome: 'Stronger discovery base'
  },
  {
    title: 'Maintenance and Support',
    text: 'Reliable updates, refinements, technical fixes, and practical support after your website goes live.',
    outcome: 'Stable long-term support'
  },
  {
...
export const proofPoints = [
  { value: '01', label: 'Strategy-first project discovery' },
  { value: '02', label: 'Responsive design for every screen' },
  { value: '03', label: 'SEO and performance foundations' },
  { value: '04', label: 'Support after launch' }
];
...
export const processSteps = [
  {
    label: '01',
    title: 'Discover',
    text: 'We clarify your goals, audience, offers, competitors, and the business actions your website must support.'
  },
  {
    label: '02',
    title: 'Design',
    text: 'We map the pages, messaging, visual direction, and user journey before development begins.'
  },
  {
    label: '03',
    title: 'Build',
  ...
  },
  {
    label: '04',
    title: 'Launch',
    text: 'We prepare deployment, review essentials, connect the inquiry flow, and support improvements after release.'
  }
];
